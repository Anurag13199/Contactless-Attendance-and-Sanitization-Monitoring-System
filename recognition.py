...
yag = yagmail.SMTP('anurag.1rn16cs012@gmail.com', '17@Nisarga')
...
while True  :
    ...
    font = cv2.FONT_HERSHEY_DUPLEX
    # service = get_service()
    # msg = create_message('anuragvs1@gmail.com', 'anurag.1rn16cs012@gmail.com', 'Attendance','Your Attendance is recorded. ',None)
